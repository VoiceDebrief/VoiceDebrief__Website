...
| Librarian | active | Keeps reality vs proposed honest; owns `reality/index.md`, the library and the master index |
...
| Historian, Journalist, Cartographer, Advocate, GRC, Alchemist, CISO | joining | As in the sibling repos, when the product's maturity warrants them |
