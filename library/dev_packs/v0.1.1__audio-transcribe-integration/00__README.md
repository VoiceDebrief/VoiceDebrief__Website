...
(source: `SGraph-AI__Tools/sgraph_ai_tools__static/tools/v0/v0.1/v0.1.60/en-gb/audio-transcribe/`)
...
| File | Role | Contents |
|------|------|----------|
| `01__conductor__scope-milestones-decisions.md` | Conductor | Scope, three milestones, decision gates, task decomposition for the implementing team |
| `02__architect__integration-architecture.md` | Architect | The import strategy, the `SgToolApi` contract, version pinning, key & spend-cap handling, privacy-mode mapping, risks |
| `03__dev__implementation-brief.md` | Dev | Concrete file plan, the exact APIs and events to bind, code sketches, error handling, testing |
| `04__designer__experience-brief.md` | Designer | The one-motion experience, streaming reveal order, progress states, mode selector, error/empty states, mobile |
...
- `library/briefs/first-product-to-market/` — the product architecture (27 Jul).
- `team/humans/dinis_cruz/briefs/07/28/v0.33.53__arch-brief__...md` — the build-session
