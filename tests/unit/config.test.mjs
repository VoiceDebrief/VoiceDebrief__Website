/* Unit tests — config.js (GBP display + the ?origin= engine override and its
   allow-list — the union of the dev (issue 037) and qa (issue 041) suites). */
...
test('?origin= only accepts allowlisted origins, end to end through location.search', async () => {
