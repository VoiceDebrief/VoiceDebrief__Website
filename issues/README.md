...
workflow declared as a JSON state machine + the flow panel; 044/045 opened.
Earlier: qa branch merged into dev's line: its parallel 036-038 renumbered to
039-041; 041 = ?origin= removed entirely, superseding both branches' allow-list
fixes; 007 closed as superseded — Dinis).
