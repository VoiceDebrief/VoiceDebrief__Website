...
**Opened:** 2026-08-08 · **Depends on:** 050

## Why

Issue 050 made CI record UI changes instead of blocking them, on the explicit
...
gate at least stopped the line. **This issue is what makes 050 sound rather than
...
- Keep it OUT of the CI gate — the point of 050 is that this judgement is not a
