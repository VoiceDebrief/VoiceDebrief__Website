/* wa-site-nav v0.1.3 — THE site header (issues 048 + 054). One source for every
...
.brand a{color:var(--wa-fg,#fff);text-decoration:none}
...
nav.main > a, .group > a{color:var(--wa-link-on-dark,#dbe6f5);text-decoration:none;font-size:.92rem;
