/* wa-progress-rail v0.1.4 — adds the "translating" step (issue 055). Both optional
   rows (translate, infographic) are hidden when the pass does not take them, so the
   rail always shows the path this run will actually walk. */
import { SgComponent } from 'https://dev.tools.sgraph.ai/components/base/v1/v1.0/v1.0.0/sg-component.js'

const STEPS = ['ingest', 'transcribe', 'translate', 'summary', 'infographic']
