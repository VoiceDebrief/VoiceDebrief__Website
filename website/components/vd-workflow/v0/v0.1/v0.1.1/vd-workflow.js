/* vd-workflow v0.1.1 — the panel from the design pack (issue 060, M3).
   ...
   Drive it:
     ...
     el.startRun([{id,label}, …])     → running (the declared path, before it runs)
...
class VdWorkflow extends HTMLElement {
    ...
    reset() {
        ...
        this._partial = null; this._steps = null; this._stopTick(); this._go('empty')
    }
...
<div class="tabs" role="tablist">${panes.map(([id, label]) => `
