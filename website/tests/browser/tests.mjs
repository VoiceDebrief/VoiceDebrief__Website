...
QUnit.module('wa-site-nav — real custom-element upgrade', () => {
    QUnit.test('two-level menu: two primary links, four groups, nineteen grouped pages (v0.1.10)', assert => {
        ...
        assert.strictEqual(sr.querySelectorAll('nav.main .group .menu a').length, 19,
            '5 library + 3 tools + 3 news + 8 engineering pages in the dropdowns')
